...
if "%DAY%"=="Friday" (
    echo Running backup for oms schema...
...
rem echo Taking full backup
rem %dmp_path% -h %PGHOST% -U %PGUSER% -p %PGPORT% -F c -b -v -f %EXPORT_DIR%\bgd_nesco_full.backup bgd_nesco
rem 
